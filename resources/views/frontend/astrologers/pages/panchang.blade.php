                                        ...
                                        <div class="shadow-pink rounded h-100">
                                            ...
                                            <div class="Choghadiya_img_day px-3 pt-3 font-14">
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['tithi']['name']}}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['nakshatra']['name']}}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['yoga']['name']}}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['karana']['name']}}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['rasi']['name']}}</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="shadow-pink rounded h-100">
                                            ...
                                            <div class="Choghadiya_img_day px-3 pt-3 font-14">
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['sun_rise']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['sun_set']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['moon_rise']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['moon_set']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['next_full_moon']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['next_new_moon']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['masa']['amanta_name']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['masa']['paksha']}}</p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2">{{$getPanchang['recordList']['response']['advanced_details']['masa']['purnimanta_name']}}</p>
                                                    </div>
                                                </div>
