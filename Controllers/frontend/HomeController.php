...
class HomeController extends Controller
{
    public function home(Request $request)
    {
        ...
        $liveastro = Http::timeout(120)->withoutVerifying()->post(url('/') . '/api/liveAstrologer/get')->json();
        $getAstrologer = Http::timeout(120)->withoutVerifying()->post(url('/') . '/api/getAstrologer')->json();
        $getAstromallProduct = Http::timeout(120)->withoutVerifying()->post(url('/') . '/api/getAstromallProduct')->json();
        ...
        $getsystemflag = Http::timeout(120)->withoutVerifying()->post(url('/') . '/api/getSystemFlag')->json();
